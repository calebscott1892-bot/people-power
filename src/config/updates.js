...
export const updates = [
  {
    ...
    highlights: [
      ...
      'In production, “entities” local stub persistence is disabled unless an Entities API is configured (fail-loudly behavior).',
      'Collaborator invites no longer depend on local profile stubs in production.',
